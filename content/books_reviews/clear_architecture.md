...
Книга посвящена, как следует из названия, вопросам построения чистой архитектуры и различных вопросов лежащих в смежных областях. Отдельное внимание автор уделяет SOLID, тестируемости кода и месте тестов в архитектуре приложения. На фоне "чистого кода" книга выглядит гораздо менее категоричной и имеет достаточно примеров того, как чрезмерное увлечение "большим и правильным" способно погубить проект.  

## Что нашел полезным для себя?

- Нашел книгу полезной для себя в целом и по этому следующий после прочтения проект стали строить по заветам дяди Боба. На момент написания ревью всем довольны, собираем профиты в виде возможности независимой разработки уровней приложения.
...
- Принцип единой ответственности в большей степени относится к акторам, чем к функциональному назначению класса. Т.е. имеется ввиду не причина, по которой должен меняться класс, а источник этих изменений;
